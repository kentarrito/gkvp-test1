...
\hypersetup{
  ...
  citecolor=blue,
  urlcolor=blue,
  pdftitle={Fusion Plasma Simulation Code Development Assisted by Large Language Models},
}

% ---- Title info ----
\title{Fusion Plasma Simulation Code Development Assisted by Large Language Models}
\author{Kentaro Seki\\
Kyoto University\\
